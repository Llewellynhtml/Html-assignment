...
export const roomData = [
  {
    ...
    description:" indulge with every conceivable luxury, the 383 sqm/4122 sqft Presidential Suite feature two bedrooms complete with king size beds and awe-inspiring view of Table ountain. Warm, neutral fabriuc imparts a residential feeling and sumptuous pillows provide splashes of colour throughout. Located in the cresccent shaped arina Rise, open-air terraces are perfectly situated to overlook Table Mountain and  and the Victoria & alfred Waterfront, whilst original works of art and photograph from south africa's most prominent artists adorn the foyer, entertainment area anddininfg room ." ,
    facilities: [
  ...
  {
    id: 4,
    name: 'Table Mountain Double Queen Room',
    description:
      'Lorem ipsum dolor sit amet consectetur adipisicing elit.Ea placeat eos sed voluptas unde veniam eligendi a. Quaerat molestiae hic omnis temporibus quos consequuntur nam voluptatum ea accusamus, corrupti nostrum eum placeat quibusdam quis beatae quae labore earum architecto aliquid debitis.',
    facilities: [
      { name: 'Wifi', icon: <FaWifi /> },
